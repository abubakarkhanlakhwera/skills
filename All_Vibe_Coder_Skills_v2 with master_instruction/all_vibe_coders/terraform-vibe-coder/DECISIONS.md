# 🏛️ DECISIONS.md — Terraform Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use Terraform 1.x | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [RDS PostgreSQL (provisioned via Terraform) for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [AWS IAM roles / service accounts — never static credentials for auth] | [reason] | [alternatives] | [team/person] |
