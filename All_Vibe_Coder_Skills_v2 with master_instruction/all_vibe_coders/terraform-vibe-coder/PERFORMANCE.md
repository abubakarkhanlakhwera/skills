# ⚡ PERFORMANCE.md — Terraform Performance Rules
...
## Terraform-Specific Performance Rules
- Use -target sparingly — it masks dependency issues
- Use terraform plan -out=plan.tfplan and apply the saved plan in CI
- Parallelize independent resource creation — Terraform does this automatically, avoid unnecessary depends_on
- Use data sources to reference existing infrastructure — don't import and manage everything
