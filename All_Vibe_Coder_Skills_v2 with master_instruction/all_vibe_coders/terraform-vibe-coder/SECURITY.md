# 🔒 SECURITY.md — Terraform Security Checklist
...
- Use IAM roles and instance profiles — never static AWS access keys
- sensitive = true on all outputs and variables containing secrets
- Use AWS Secrets Manager or HashiCorp Vault — never store secrets in tfvars
- Enable S3 backend versioning and DynamoDB locking
- Run tfsec or checkov in CI to catch security misconfigurations
