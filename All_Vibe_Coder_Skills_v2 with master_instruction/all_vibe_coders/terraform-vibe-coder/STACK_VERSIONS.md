# 📌 STACK_VERSIONS.md — Terraform Pinned Versions
...
```yaml
hashicorp/aws                 : [run your package manager to find installed version]
hashicorp/google              : [run your package manager to find installed version]
hashicorp/azurerm             : [run your package manager to find installed version]
terraform-aws-modules         : [run your package manager to find installed version]
```
