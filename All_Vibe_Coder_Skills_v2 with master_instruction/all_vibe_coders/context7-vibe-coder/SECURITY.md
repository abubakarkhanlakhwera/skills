# 🔒 SECURITY.md — Context7 Security Checklist
> Stack-specific security rules for this project.
> The AI must check these before suggesting any auth, data, or config code.

## Context7-Specific Security Rules
- Context7 fetches from official documentation sources only
- No authentication data is sent to Context7
- Context7 does not store your queries — stateless per request
