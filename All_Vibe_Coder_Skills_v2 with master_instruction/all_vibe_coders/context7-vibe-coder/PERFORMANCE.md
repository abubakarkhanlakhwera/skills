# ⚡ PERFORMANCE.md — Context7 Performance Rules
...
## Context7-Specific Performance Rules
- Use tokens: 3000-5000 for focused topics — 8000+ only for large API surfaces
- Re-use resolved library IDs within a session — no need to re-resolve
- Fetch once per library per session unless you change the topic
