# 🏛️ DECISIONS.md — LangChain Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use LangChain 0.2+ / LangGraph | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [pgvector or Chroma for vector store for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [API keys via environment only — never hardcoded for auth] | [reason] | [alternatives] | [team/person] |
