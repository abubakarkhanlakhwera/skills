# ⚡ PERFORMANCE.md — LangChain Performance Rules
...
## LangChain-Specific Performance Rules
- Use astream for streaming responses to users — never wait for full completion
- Cache LLM calls with langchain.cache for identical prompts in dev
- Use smaller embedding model for retrieval, larger LLM for generation
- Tune chunk_size and chunk_overlap based on retrieval recall — measure it
