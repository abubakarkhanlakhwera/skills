# 📌 STACK_VERSIONS.md — Streamlit Pinned Versions
...
```yaml
streamlit                     : [run your package manager to find installed version]
pandas                        : [run your package manager to find installed version]
plotly                        : [run your package manager to find installed version]
sqlalchemy                    : [run your package manager to find installed version]
streamlit-authenticator       : [run your package manager to find installed version]
```
