# ⚡ PERFORMANCE.md — Electron Performance Rules
...
## Electron-Specific Performance Rules
- Lazy-load renderer windows — don't create all windows on app startup
- Use worker_threads for CPU-intensive work in main process
- Compress IPC payloads for large data transfers
- Use electron-store for settings — not synchronous file I/O
