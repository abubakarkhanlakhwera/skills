# 🔒 SECURITY.md — Electron Security Checklist
...
- Validate and sanitize all data received via IPC in main process
- Use keytar for credential storage — never localStorage or electron-store for secrets
- Disable remote module — it is deprecated and insecure
- Content Security Policy must be set on every BrowserWindow
