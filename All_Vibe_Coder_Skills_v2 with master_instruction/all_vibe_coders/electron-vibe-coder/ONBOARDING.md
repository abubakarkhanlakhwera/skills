# 🚀 ONBOARDING.md — Electron New Developer Guide
...
|-------|-----------|---------|----------------|
| Language | TypeScript | 30.x | [reason] |
| Framework | Electron 30+ + Vite | — | [reason] |
| Database | SQLite via better-sqlite3 (main process only) | — | [reason] |
| Auth | Local session via keytar + JWT | — | [reason] |
| Deploy | electron-builder for Windows/macOS/Linux + auto-update via electron-updater | — | [reason] |
...
### Things We Never Do
- nodeIntegration: true — always false
- Storing sensitive data in localStorage — use keytar
- Direct file system access from renderer — always via IPC to main
