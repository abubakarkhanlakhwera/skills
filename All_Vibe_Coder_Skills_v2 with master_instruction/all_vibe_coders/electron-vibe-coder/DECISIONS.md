# 🏛️ DECISIONS.md — Electron Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use Electron 30+ + Vite | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [SQLite via better-sqlite3 (main process only) for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [Local session via keytar + JWT for auth] | [reason] | [alternatives] | [team/person] |
