# 📌 STACK_VERSIONS.md — dbt Pinned Versions
...
```yaml
dbt-core                      : [run your package manager to find installed version]
dbt-utils                     : [run your package manager to find installed version]
dbt-expectations              : [run your package manager to find installed version]
elementary-data               : [run your package manager to find installed version]
```
