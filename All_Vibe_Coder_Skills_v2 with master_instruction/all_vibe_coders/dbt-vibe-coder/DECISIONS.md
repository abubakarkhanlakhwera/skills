# 🏛️ DECISIONS.md — dbt Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use dbt Core / dbt Cloud | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [BigQuery / Snowflake / Redshift / DuckDB for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [Service account or SSO via dbt Cloud for auth] | [reason] | [alternatives] | [team/person] |
