# 📌 STACK_VERSIONS.md — Docker + Compose Pinned Versions
...
```yaml
docker                        : [run your package manager to find installed version]
docker-compose                : [run your package manager to find installed version]
traefik                       : [run your package manager to find installed version]
watchtower                    : [run your package manager to find installed version]
```
