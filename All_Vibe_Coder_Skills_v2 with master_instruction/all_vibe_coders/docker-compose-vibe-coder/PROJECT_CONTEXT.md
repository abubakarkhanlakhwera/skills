# 📋 PROJECT_CONTEXT.md — Docker + Compose
...
Framework     : Docker 25+ / Compose v2
Environment   : [development / staging / production]
```

## Stack Details
```yaml
DB / Store    : PostgreSQL:16-alpine
Auth          : N/A — handled by application layer
Deploy Target : docker compose up -d in production / Swarm / Kubernetes
Key Libraries : docker, docker-compose, traefik, watchtower
```
