# 🔍 REVIEW_CHECKLIST.md — Docker + Compose Code Review Checklist
...
- [ ] Is multi-stage build used — no build tools in final image?
- [ ] Is non-root USER set in production stage?
- [ ] Are all image tags pinned — no latest?
- [ ] Are healthchecks defined on all services?
- [ ] Are named volumes used — no host bind-mounts for persistent data?
