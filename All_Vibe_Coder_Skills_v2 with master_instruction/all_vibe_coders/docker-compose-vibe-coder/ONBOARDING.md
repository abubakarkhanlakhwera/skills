# 🚀 ONBOARDING.md — Docker + Compose New Developer Guide
...
|-------|-----------|---------|----------------|
| Language | Dockerfile / YAML | 25.x | [reason] |
| Framework | Docker 25+ / Compose v2 | — | [reason] |
| Database | PostgreSQL:16-alpine | — | [reason] |
| Auth | N/A — handled by application layer | — | [reason] |
| Deploy | docker compose up -d in production / Swarm / Kubernetes | — | [reason] |
