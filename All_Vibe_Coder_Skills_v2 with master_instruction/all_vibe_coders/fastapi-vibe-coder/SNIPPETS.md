# 🧩 SNIPPETS.md — FastAPI Approved Code Snippets
...
async def get_item(
    ...
    return await item_service.get_by_id(db, item_id, current_user)
```
...
4. Commit with message: `snippets(fastapi): add [name]`
