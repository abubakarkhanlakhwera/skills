# 🏛️ DECISIONS.md — FastAPI Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use FastAPI + Pydantic v2 | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [PostgreSQL via SQLAlchemy 2.x async for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [JWT via python-jose + OAuth2PasswordBearer for auth] | [reason] | [alternatives] | [team/person] |
