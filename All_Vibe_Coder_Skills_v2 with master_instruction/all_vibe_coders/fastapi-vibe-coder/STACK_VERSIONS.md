# 📌 STACK_VERSIONS.md — FastAPI Pinned Versions
...
```yaml
fastapi                       : [run your package manager to find installed version]
pydantic                      : [run your package manager to find installed version]
sqlalchemy                    : [run your package manager to find installed version]
alembic                       : [run your package manager to find installed version]
httpx                         : [run your package manager to find installed version]
```
