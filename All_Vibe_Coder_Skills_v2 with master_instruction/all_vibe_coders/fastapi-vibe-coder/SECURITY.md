# 🔒 SECURITY.md — FastAPI Security Checklist
...
- Always use OAuth2 scopes for endpoint authorization
- Rate-limit auth endpoints with slowapi
- Validate and sanitize all query parameters — never pass raw to ORM
