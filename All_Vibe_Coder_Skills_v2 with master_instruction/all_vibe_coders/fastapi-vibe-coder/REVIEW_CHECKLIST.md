# 🔍 REVIEW_CHECKLIST.md — FastAPI Code Review Checklist
...
- [ ] Does every route have response_model= set?
- [ ] Is all business logic in services/, not in routers/?
- [ ] Are DB queries using async sessions?
- [ ] Are there N+1 query risks? Use selectinload() or joinedload()
- [ ] Are all inputs validated with Pydantic before touching services?
