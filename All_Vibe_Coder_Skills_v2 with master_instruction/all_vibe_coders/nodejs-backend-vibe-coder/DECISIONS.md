# 🏛️ DECISIONS.md — Node.js Backend Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use Express + Zod | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [PostgreSQL via Prisma ORM for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [JWT via jsonwebtoken + express middleware for auth] | [reason] | [alternatives] | [team/person] |
