# 📌 STACK_VERSIONS.md — Node.js Backend Pinned Versions
...
```yaml
express                       : [run your package manager to find installed version]
zod                           : [run your package manager to find installed version]
prisma                        : [run your package manager to find installed version]
jsonwebtoken                  : [run your package manager to find installed version]
pino                          : [run your package manager to find installed version]
```
