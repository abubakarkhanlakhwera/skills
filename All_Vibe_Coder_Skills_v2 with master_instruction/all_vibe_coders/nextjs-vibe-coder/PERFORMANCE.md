# ⚡ PERFORMANCE.md — Next.js Performance Rules
...
- Use React cache() to deduplicate RSC data fetching per request
- Set appropriate fetch() cache and revalidate options per data type
- Use next/dynamic for heavy client components — lazy load below fold
- Optimize images with next/image and correct sizes prop
