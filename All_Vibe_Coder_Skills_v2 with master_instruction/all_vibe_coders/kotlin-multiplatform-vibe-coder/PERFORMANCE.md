# ⚡ PERFORMANCE.md — Kotlin Multiplatform Performance Rules
...
## Kotlin Multiplatform-Specific Performance Rules
- Use Dispatchers.IO for network/DB in shared code — never Default for I/O
- SQLDelight queries use transactions for bulk operations
- Use kotlinx.coroutines flow operators (conflate, debounce) to reduce UI updates
- Profile Android with Android Studio Profiler, iOS with Instruments
