# 🔒 SECURITY.md — Kotlin Multiplatform Security Checklist
> Stack-specific security rules for this project.
> The AI must check these before suggesting any auth, data, or config code.

## Kotlin Multiplatform-Specific Security Rules
- Use expect/actual for platform keychain — never store tokens in shared preferences
- Certificate pinning implemented per platform via expect/actual HttpClient engine
- Sensitive data never in shared module logging — platform-level log filtering
