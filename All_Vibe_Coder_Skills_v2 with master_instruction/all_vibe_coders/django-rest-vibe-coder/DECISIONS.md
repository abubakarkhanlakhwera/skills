# 🏛️ DECISIONS.md — Django REST Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use Django 5.x + DRF | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [PostgreSQL via Django ORM for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [JWT via djangorestframework-simplejwt for auth] | [reason] | [alternatives] | [team/person] |
