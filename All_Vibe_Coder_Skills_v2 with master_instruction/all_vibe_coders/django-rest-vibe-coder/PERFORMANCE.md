# ⚡ PERFORMANCE.md — Django REST Performance Rules
...
## Django REST-Specific Performance Rules
- Use select_related() for ForeignKey and OneToOne, prefetch_related() for ManyToMany
- Add db_index=True to all frequently filtered fields
- Use Django's cache framework for expensive querysets
- Use Celery for email sending, image processing, and any work >100ms
