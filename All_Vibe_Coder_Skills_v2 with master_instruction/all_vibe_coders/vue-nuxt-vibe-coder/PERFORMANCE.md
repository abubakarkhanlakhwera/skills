# ⚡ PERFORMANCE.md — Vue + Nuxt Performance Rules
...
## Vue + Nuxt-Specific Performance Rules
- Use useLazyFetch() for non-critical data to unblock page render
- Use useNuxtData() to share useFetch() cache between components
- Lazy-import heavy components with defineAsyncComponent()
- Use Nuxt Image (nuxt/image) for all images
