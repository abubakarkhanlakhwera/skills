# 🔍 REVIEW_CHECKLIST.md — Vue + Nuxt Code Review Checklist
...
- [ ] Is data fetching using useFetch() or useAsyncData() — not onMounted fetch?
- [ ] Are server API routes validated with Zod?
- [ ] Is Pinia state only mutated in actions?
- [ ] Are private env vars not exposed to client config?
