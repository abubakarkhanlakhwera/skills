# 📌 STACK_VERSIONS.md — Vue + Nuxt Pinned Versions
...
```yaml
nuxt                          : [run your package manager to find installed version]
pinia                         : [run your package manager to find installed version]
vueuse                        : [run your package manager to find installed version]
