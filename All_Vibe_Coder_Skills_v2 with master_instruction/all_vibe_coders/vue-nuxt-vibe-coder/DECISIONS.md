# 🏛️ DECISIONS.md — Vue + Nuxt Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use Nuxt 3 + Vue 3 | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [PostgreSQL via Drizzle ORM or Prisma in server/ for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [nuxt-auth-utils or sidebase/nuxt-auth for auth] | [reason] | [alternatives] | [team/person] |
