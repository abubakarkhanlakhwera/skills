# 📌 STACK_VERSIONS.md — Tauri Pinned Versions
...
```yaml
tauri                         : [run your package manager to find installed version]
serde                         : [run your package manager to find installed version]
tokio                         : [run your package manager to find installed version]
tauri-plugin-store            : [run your package manager to find installed version]
tauri-plugin-http             : [run your package manager to find installed version]
```
