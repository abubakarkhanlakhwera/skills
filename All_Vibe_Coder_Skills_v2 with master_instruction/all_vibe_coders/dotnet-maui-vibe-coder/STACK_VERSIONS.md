# 📌 STACK_VERSIONS.md — .NET MAUI Pinned Versions
...
```yaml
CommunityToolkit.Mvvm         : [run your package manager to find installed version]
CommunityToolkit.Maui         : [run your package manager to find installed version]
sqlite-net-pcl                : [run your package manager to find installed version]
Refit                         : [run your package manager to find installed version]
```
