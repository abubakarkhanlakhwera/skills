# ⚡ PERFORMANCE.md — .NET MAUI Performance Rules
...
## .NET MAUI-Specific Performance Rules
- Use CollectionView not ListView for all lists — better virtualization
- Use Shell lazy loading — not all pages loaded on startup
- Profile with dotnet-trace and Visual Studio Profiler before optimizing
- Use CachingHttpClient for API calls that don't need real-time data
- Avoid large images without ResizeWidth/ResizeHeight — causes memory pressure
