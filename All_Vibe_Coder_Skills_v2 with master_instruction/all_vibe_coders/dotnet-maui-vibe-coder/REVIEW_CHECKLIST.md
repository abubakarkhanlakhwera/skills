# 🔍 REVIEW_CHECKLIST.md — .NET MAUI Code Review Checklist
> Run through this before every PR is merged.
> The AI should self-check against this before presenting code.

## .NET MAUI-Specific Checks
- [ ] Is all logic in the ViewModel, not code-behind?
- [ ] Are [ObservableProperty] and [RelayCommand] used — no manual INotifyPropertyChanged?
- [ ] Is navigation using Shell routes?
- [ ] Are secrets in SecureStorage, not Preferences?
- [ ] Are CollectionViews used instead of ListViews?
