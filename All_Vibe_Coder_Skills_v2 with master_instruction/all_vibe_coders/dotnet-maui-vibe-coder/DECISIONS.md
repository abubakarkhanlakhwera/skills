# 🏛️ DECISIONS.md — .NET MAUI Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use .NET MAUI + CommunityToolkit.Mvvm | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [SQLite via sqlite-net-pcl or cloud via HttpClient for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [MSAL (Microsoft Authentication Library) or custom JWT for auth] | [reason] | [alternatives] | [team/person] |
