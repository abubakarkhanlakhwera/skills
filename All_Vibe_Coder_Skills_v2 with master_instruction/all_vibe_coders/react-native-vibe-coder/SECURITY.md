# 🔒 SECURITY.md — React Native Security Checklist
...
- Store tokens in expo-secure-store — never AsyncStorage for sensitive data
- Use HTTPS for all API calls — no HTTP in production
- Never embed API keys in the app bundle — use EAS secrets
- Use expo-crypto for any cryptographic operations
