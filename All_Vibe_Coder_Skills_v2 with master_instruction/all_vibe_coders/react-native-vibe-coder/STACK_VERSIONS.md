# 📌 STACK_VERSIONS.md — React Native Pinned Versions
...
```yaml
expo                          : [run your package manager to find installed version]
react-navigation              : [run your package manager to find installed version]
react-query                   : [run your package manager to find installed version]
zustand                       : [run your package manager to find installed version]
expo-secure-store             : [run your package manager to find installed version]
```
