# 📌 STACK_VERSIONS.md — Spring Boot Pinned Versions
...
```yaml
spring-boot-starter-web       : [run your package manager to find installed version]
spring-data-jpa               : [run your package manager to find installed version]
spring-security               : [run your package manager to find installed version]
lombok                        : [run your package manager to find installed version]
mapstruct                     : [run your package manager to find installed version]
```
