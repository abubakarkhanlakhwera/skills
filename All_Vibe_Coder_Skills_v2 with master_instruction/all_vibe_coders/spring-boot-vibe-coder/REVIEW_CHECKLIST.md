# 🔍 REVIEW_CHECKLIST.md — Spring Boot Code Review Checklist
...
- [ ] Are DTOs used — no JPA entities in REST responses?
- [ ] Is MapStruct used for entity↔DTO mapping?
- [ ] Is @Transactional only on service methods?
- [ ] Are N+1 risks addressed with @EntityGraph or fetch joins?
