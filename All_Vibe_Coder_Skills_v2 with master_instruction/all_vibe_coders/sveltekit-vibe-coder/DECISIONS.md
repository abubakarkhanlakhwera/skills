# 🏛️ DECISIONS.md — SvelteKit Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use SvelteKit 2 + Svelte 5 | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [PostgreSQL via Drizzle ORM for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [Lucia Auth or SvelteKit sessions for auth] | [reason] | [alternatives] | [team/person] |
