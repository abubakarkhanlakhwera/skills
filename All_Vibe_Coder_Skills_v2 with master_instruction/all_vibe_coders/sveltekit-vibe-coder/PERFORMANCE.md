# ⚡ PERFORMANCE.md — SvelteKit Performance Rules
...
## SvelteKit-Specific Performance Rules
- Use SvelteKit streaming (return deferred promises in load) for slow data
- Cache load() results with cache-control headers for static data
- Use Svelte 5 fine-grained reactivity ($derived) — avoid $effect for derived values
- Preload routes with data-sveltekit-preload-data on navigation links
