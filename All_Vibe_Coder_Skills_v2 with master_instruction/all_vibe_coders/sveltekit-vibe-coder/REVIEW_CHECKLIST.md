# 🔍 REVIEW_CHECKLIST.md — SvelteKit Code Review Checklist
...
- [ ] Are all mutations using form actions with use:enhance?
- [ ] Is all SSR data fetched in +page.server.ts load()?
- [ ] Are server-only modules in $lib/server/?
- [ ] Is Zod validation applied in all form actions?
- [ ] Are auth checks present in every load() and action?
