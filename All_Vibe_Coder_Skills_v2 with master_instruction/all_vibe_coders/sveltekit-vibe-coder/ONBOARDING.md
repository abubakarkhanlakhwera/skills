# 🚀 ONBOARDING.md — SvelteKit New Developer Guide
...
|-------|-----------|---------|----------------|
| Language | TypeScript | 2.x | [reason] |
| Framework | SvelteKit 2 + Svelte 5 | — | [reason] |
| Database | PostgreSQL via Drizzle ORM | — | [reason] |
| Auth | Lucia Auth or SvelteKit sessions | — | [reason] |
| Deploy | Vercel / Cloudflare Pages / Node adapter + Docker | — | [reason] |
