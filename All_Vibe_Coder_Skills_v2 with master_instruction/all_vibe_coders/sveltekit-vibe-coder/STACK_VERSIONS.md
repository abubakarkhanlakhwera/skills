# 📌 STACK_VERSIONS.md — SvelteKit Pinned Versions
...
```yaml
sveltekit                     : [run your package manager to find installed version]
drizzle-orm                   : [run your package manager to find installed version]
lucia                         : [run your package manager to find installed version]
