# ⚡ PERFORMANCE.md — Go + Gin Performance Rules
...
## Go + Gin-Specific Performance Rules
- Use pgx connection pool — never open a new connection per request
- Use sqlc for compile-time safe queries — no reflection-based ORM overhead
- Use sync.Pool for frequently allocated structs in hot paths
- Use Go benchmarks (testing.B) before claiming a performance win
