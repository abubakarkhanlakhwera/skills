# 📌 STACK_VERSIONS.md — Go + Gin Pinned Versions
...
```yaml
gin                           : [run your package manager to find installed version]
pgx                           : [run your package manager to find installed version]
sqlc                          : [run your package manager to find installed version]
golang-jwt                    : [run your package manager to find installed version]
zap                           : [run your package manager to find installed version]
```
