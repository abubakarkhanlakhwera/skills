# 🚀 ONBOARDING.md — Go + Gin New Developer Guide
...
|-------|-----------|---------|----------------|
| Language | Go 1.22+ | 1.22.x | [reason] |
| Framework | Gin Web Framework | — | [reason] |
| Database | PostgreSQL via pgx/v5 + sqlc | — | [reason] |
| Auth | JWT via golang-jwt/jwt | — | [reason] |
| Deploy | Docker multi-stage + fly.io / Railway | — | [reason] |
