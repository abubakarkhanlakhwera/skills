# 🚀 ONBOARDING.md — NestJS New Developer Guide
...
|-------|-----------|---------|----------------|
| Language | TypeScript | 10.x | [reason] |
| Framework | NestJS 10+ | — | [reason] |
| Database | PostgreSQL via TypeORM or Prisma | — | [reason] |
| Auth | JWT via @nestjs/jwt + Passport | — | [reason] |
...
### Things We Never Do
- Business logic in controllers — always services
- Manual DTO validation — always class-validator decorators + ValidationPipe
- Direct TypeORM repository injection in controllers — service layer only
