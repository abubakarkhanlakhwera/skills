# 🔒 SECURITY.md — NestJS Security Checklist
...
- Use @UseGuards(JwtAuthGuard) on all protected controllers or routes
- Enable helmet() in main.ts for security headers
- Rate limiting with @nestjs/throttler on all public endpoints
- Use class-validator whitelist:true to strip unknown properties
