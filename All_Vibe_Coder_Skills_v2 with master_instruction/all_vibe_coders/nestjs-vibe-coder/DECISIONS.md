# 🏛️ DECISIONS.md — NestJS Architecture Decision Records
...
|------|----------|-----|------------------------|------------|
| [YYYY-MM-DD] | Use NestJS 10+ | [reason] | [other options] | [team/person] |
| [YYYY-MM-DD] | [PostgreSQL via TypeORM or Prisma for persistence] | [reason] | [alternatives] | [team/person] |
| [YYYY-MM-DD] | [JWT via @nestjs/jwt + Passport for auth] | [reason] | [alternatives] | [team/person] |
