# 📌 STACK_VERSIONS.md — NestJS Pinned Versions
...
```yaml
@nestjs/core                  : [run your package manager to find installed version]
@nestjs/jwt                   : [run your package manager to find installed version]
class-validator               : [run your package manager to find installed version]
typeorm                       : [run your package manager to find installed version]
